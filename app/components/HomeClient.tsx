      ...
      <main className="flex-grow flex flex-col">
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-8">
            ...
            <h1 className="font-syne text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold leading-[1.05] tracking-tight animate-fade-in-up delay-200">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              >
                ...
                <h2 className="font-syne text-base font-bold mb-2">{f.title}</h2>
