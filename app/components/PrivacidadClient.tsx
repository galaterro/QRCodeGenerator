  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow mx-auto w-full max-w-3xl px-6 py-12">
        ...
        <h1 className="mb-2 text-3xl font-syne font-bold">Política de Privacidad y Cookies</h1>
        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">2. Datos que se recogen</h2>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">3. Finalidad y base legal</h2>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">4. Cookies</h2>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">5. Conservación de los datos</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">6. Destinatarios</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">7. Tus derechos</h2>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold">8. Reclamaciones</h2>
            <p className="text-muted-foreground">
